    ...
    <SubPageLayout>
      <section className={`min-h-screen px-4 sm:px-6 lg:px-8 py-24 transition-all duration-700 ${sectionBg}`}>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className={`absolute bottom-1/4 -right-20 w-96 h-96 rounded-full blur-3xl opacity-10 ${theme === "dark" ? "bg-blue-500" : "bg-cyan-400"
            }`} />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto space-y-20 z-10">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className={`p-8 rounded-3xl backdrop-blur-sm border-2 transition-all duration-300 hover:scale-105 ${cardBg} ${theme === "dark" ? "hover:border-emerald-500/50" : "hover:border-blue-500/50"
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className={`font-bold ${inter.className} ${theme === "dark" ? "text-emerald-300" : "text-blue-600"
                      }`}>Brian K.</p>
              ...
              <div className={`p-8 rounded-3xl backdrop-blur-sm border-2 transition-all duration-300 hover:scale-105 ${cardBg} ${theme === "dark" ? "hover:border-blue-500/50" : "hover:border-emerald-500/50"
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className={`font-bold ${inter.className} ${theme === "dark" ? "text-blue-300" : "text-cyan-600"
                      }`}>Sarah M.</p>
          ...
          {/* Pricing CTA */}
          <div className={`rounded-3xl p-12 text-center backdrop-blur-sm border-2 ${cardBg} ${theme === "dark" ? "border-emerald-500/30" : "border-blue-500/30"
            }`}>
            <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full border backdrop-blur-sm mb-6 ${theme === "dark"
              ? "border-emerald-500/30 bg-emerald-500/10 text-emerald-200"
              : "border-blue-500/30 bg-blue-500/10 text-blue-700"
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 mb-8">
              <div className="text-center">
                <p className={`text-5xl md:text-6xl font-bold mb-2 ${inter.className} ${theme === "dark" ? "text-purple-300" : "text-blue-600"
                  }`}>
                  $199
                </p>
