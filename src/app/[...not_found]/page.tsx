  ...
  return (
    <div className={`min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 transition-all duration-700 ${sectionBg}`}>
      ...
      <div className="relative max-w-2xl mx-auto text-center z-10">
        {/* Error Code */}
        <div className="mb-8">
          <div className={`text-8xl md:text-9xl font-bold mb-4 ${playfair.className} ${theme === "dark" ? "text-gray-700" : "text-gray-200"
            }`}>
            404
          </div>
        ...
        {/* Illustration/Icon */}
        <div className="mb-8">
          <div className={`inline-flex items-center justify-center w-24 h-24 rounded-3xl mb-4 ${theme === "dark"
        ...
        {/* Quick Links */}
        <div className={`p-6 rounded-3xl backdrop-blur-sm border ${theme === "dark"
          ? "bg-gray-800/50 border-gray-700"
          : "bg-white/80 border-gray-200"
          }`}>
          <h3 className={`text-lg font-bold mb-4 ${inter.className} ${theme === "dark" ? "text-white" : "text-gray-900"
            }`}>
            Popular Pages
          </h3>
        ...
        {/* Support Contact */}
        <div className="mt-8">
          <p className={`text-sm ${inter.className} ${theme === "dark" ? "text-gray-400" : "text-gray-500"
            }`}>
            Need help?{" "}
            <a
              href="mailto:support@stoicpips.com"
              className={`font-semibold hover:underline ${theme === "dark" ? "text-purple-400" : "text-blue-600"
                }`}
            >
              Contact Support
            </a>
